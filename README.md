...
[![My Skills](https://skillicons.dev/icons?i=js,html,css,angular,bootstrap,cs,docker,express,figma,java,linux,mysql,nodejs,php,postgres,postman,react,redux,spring,symfony,ts,)](https://skillicons.dev)
