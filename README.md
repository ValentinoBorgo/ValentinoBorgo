...
[![My Skills](https://skillicons.dev/icons?i=java,spring,php,symfony,js,ts,html,css,react,redux,angular,bootstrap,cs,docker,nodejs,express,figma,linux,mysql,postgres,postman,)](https://skillicons.dev)
